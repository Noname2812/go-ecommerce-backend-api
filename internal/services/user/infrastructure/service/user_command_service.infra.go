...
func NewUserCommandService(up usermessaging.UserPublisherHandler, uir userrepository.UserInfoRepository, rdb *redis.Client) userservice.UserCommandService {
