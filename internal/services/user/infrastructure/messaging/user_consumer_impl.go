...
import (
	...
	userconsts "github.com/Noname2812/go-ecommerce-backend-api/internal/services/user/consts"
...
func (c *userEventConsumer) Subscribe() error {
	...
	if err := c.kafkaManager.AddConsumer(commonkafka.TOPIC_USER_BASE_INSERTED, commonkafka.GROUP_USER_BASE_INSERTED, c.HandleUserBaseInserted, userconsts.COUNT_WORKER_HANDLER_USER_BASE_INSERTED, nil); err != nil {
		return err
	}
	return nil
}
