...
SELECT user_id, user_account, user_nickname, user_avatar, user_state, user_phone, user_gender, user_birthday, user_address, user_is_authentication, created_at, updated_at, deleted_at FROM acc_user_info WHERE user_account LIKE ? OR user_nickname LIKE ?
`
...
SELECT user_id, user_account, user_nickname, user_avatar, user_state, user_phone, user_gender, user_birthday, user_address, user_is_authentication, created_at, updated_at, deleted_at FROM acc_user_info LIMIT ? OFFSET ?
`
